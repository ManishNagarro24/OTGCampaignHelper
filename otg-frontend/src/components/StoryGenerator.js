    ...
    <div className="_26LpG" >
      ...
      <div className="_2pASI _9QpxU">
        ...
        <section className="_1UAeM jg-background--white">
          ...
          <Link to="/6" style={{ textDecoration: 'none', color: 'white' }}>
          <button style={{borderColor:"lightGray" ,backgroundColor:"#af96d7",borderRadius:"9px",marginLeft:"300px",fontStyle:"courier"}} class="btn btn-secondary">Apply Suggestions</button>
...
const SectionComponent = () => {
    ...
    const sectionData = [
      ...
      { label: 'Highlight the success of this story to motivate people to donate more Try to add phrases like: Keep up the excellent work, Paws of Love! ' },

      { label: 'Encourage people to adopt animals from shelters Try to add phrases like What a fantastic way to teach kids compassion!' },

      { label: 'Submit adorable pictures of their furry Try to add phrases like I cant resist those cute pet photos!' },

      { label: 'grateful and heartwarming tone Try to add phrases like : The young and old brought smiles to each other faces!, I am proud to be a part of this campaign.' }
       ...
       <label style={{fontSize:"13px",marginTop:"2px",marginBottom:"10px",textAlign:"center",fontWeight:"bold",color:"#6f45b4",fontStyle:"courier"}}>Statistics demonstrate successful stories incorporating these suggestions. Choose from below to achieve your goals.</label>
        ...
        {sectionData.map((section, index) => (
          ...
          <div
            ...
            style =  {(index) == 3 ?sectionStyle1 :sectionStyle}
